...
def run_script():
    ...
    repo_path = '/content/Mangio-RVC-Fork-Simple-CLI'
    ...
    def clone_and_copy_repo(repo_path):
        # New repository link
        new_repo_link = "https://github.com/justinjohn0306/Mangio-RVC-Fork-Simple-CLI/"
        # Temporary path to clone the repository
        temp_repo_path = "/content/temp_Mangio-RVC-Fork-Simple-CLI"
        # New folder name
        new_folder_name = "Mangio-RVC-Fork-Simple-CLI"
    ...
    os.makedirs('/content/Mangio-RVC-Fork-Simple-CLI/stats/', exist_ok=True)
    run_cmd("wget -q https://cdn.discordapp.com/attachments/945486970883285045/1114717554481569802/peppy-generator-388800-07722f17a188.json -O /content/Mangio-RVC-Fork-Simple-CLI/stats/peppy-generator-388800-07722f17a188.json")

    # Forcefully delete any existing torchcrepe dependencies downloaded from an earlier run just in case
    shutil.rmtree('/content/Mangio-RVC-Fork-Simple-CLI/torchcrepe', ignore_errors=True)
    ...
    shutil.move('/content/torchcrepe/torchcrepe', '/content/Mangio-RVC-Fork-Simple-CLI/')
    shutil.rmtree('/content/torchcrepe', ignore_errors=True)  # Delete the torchcrepe repository folder

    # Change the current directory to /content/Mangio-RVC-Fork-Simple-CLI
    os.chdir('/content/Mangio-RVC-Fork-Simple-CLI')
...
def download_pretrained_models():
    ...
    base_path = "/content/Mangio-RVC-Fork-Simple-CLI/"
